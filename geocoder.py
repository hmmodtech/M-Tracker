...
def find_location(text):
    ...
    # Pass 3 و Pass 4 تم حذفهم عن قصد:
    # البحث العشوائي بالـ tokens كان يعطي أماكن خاطئة من خارج غزة
    # (مثل مطابقة كلمات من "الضفة الغربية" أو أسماء أشخاص مع أحياء في غزة)
    # النظام الآن يعتمد فقط على الأماكن المذكورة صراحةً في النص
    return None
